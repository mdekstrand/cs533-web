...
Ablation study
    ...
    Introduced in {video}`1-1 - Introduction`.

    Introduced in [:material-video: Inference and Albation](../content/week11/index.md#ablation).
...
Statistic
    ...
    Discussed in [:material-video: Inference Intro](../content/week4/index.md#introduction).
